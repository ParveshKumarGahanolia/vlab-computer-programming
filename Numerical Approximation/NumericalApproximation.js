...
window.view = {
	wavelengthController: .0393, //control wavelength of cos curve.
	...
	drawAxis: function () {
		...
		this.canvasContext.lineTo(20, 360); // 20 is x-coordinate value and 360 is y-coordinate value.
		this.canvasContext.moveTo(20, 180); // 20 is x-coordinate value and 180 is y-coordinate value.
		this.canvasContext.lineTo(520, 180); // 520 is x-coordinate value and 180 is y-coordinate value.
	...
	drawText: function () {
		...
		this.canvasContext.beginPath();
		this.canvasContext.fillText('0', 8, 180); // 0 is text that to be display, 8 is x-coordinate value and 180 is y-coordinate value.
		this.canvasContext.fillText('1', 8, 100); // 1 is text that to be display, 8 is x-coordinate value and 100 is y-coordinate value.
		this.canvasContext.fillText('2', 8, 20); // 2 is text that to be display, 8 is x-coordinate value and 20 is y-coordinate value.
		this.canvasContext.fillText('1', 8, 260); // 1 is text that to be display, 8 is x-coordinate value and 260 is y-coordinate value.
		this.canvasContext.fillText('2', 8, 340); // 2 is text that to be display, 8 is x-coordinate value and 340 is y-coordinate value.
		...
		for (var position = 80; position <= 500; position += 60) {
			this.canvasContext.fillText(value, position, 200); // 200 is y-coordinate value.
			value += 5;
		}
	},
	...
	drawIntersectLines: function () {
		...
		for (var position = 80; position <= 500; position += 60) {
			this.canvasContext.moveTo(position, 175); // position is x-coordinate value and 175 or 185 are y-coordinate value where intersectlines to be display.
